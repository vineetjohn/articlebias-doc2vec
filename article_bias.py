...
from processors.fact_check_processor_bigram import FactCheckProcessorBigram
from processors.fact_check_processor_doc2vec import FactCheckProcessorDocvec
