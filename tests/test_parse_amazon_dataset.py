...
positive_review_file_path = "/home/v2john/Documents/amazon/books_reviews_pos.txt"
negative_review_file_path = "/home/v2john/Documents/amazon/books_reviews_neg.txt"
...
pos = open(positive_review_file_path, 'w')
neg = open(negative_review_file_path, 'w')
